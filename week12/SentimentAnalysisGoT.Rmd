...
lord
```
So i can see, that lord is both representing 'disgust' and 'trust' but also 'negativ' and 'positive' which makes sense if you know the GoT, because so many different people gets called "lord" so it differs from whom gets called, there is a difference if its ned stark og little finger. 
