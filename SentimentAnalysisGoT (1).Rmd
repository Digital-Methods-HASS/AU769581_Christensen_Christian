...
The mean and median indicate *slightly* negativ overall sentiments based on the AFINN lexicon. 
...
"Lord" is showing up in more NRC lexicons, ill check which ones:
```{r nrc-confidence}
...
lord
```
Det kan ses at Lord er repærsenteret i flere forskellige "humør-kategorier", altså både i "digust" og "trust" men samtidigt også i "negativ" og "positive". At de ordet lord er i mange maodstridende humør-kategorier, kan skyldes at der er mange af karakterne som bliver kaldt "Lord", både fra den gode og den dårlige side af fortællingen. Dette kan forklare at det samme ord kan fremkomme i forskellige kategorier.
